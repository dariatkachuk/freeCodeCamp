...
let getAverageFiltArray = function(list, director) {
  return list
    .filter(item => item['Director'] === director)
    .reduce((acc, curr, ind, arr) => {
      return acc + +curr['imdbRating']/arr.length;
      }, 0);
} 

let averageRating = getAverageFiltArray(watchList, "Christopher Nolan");
